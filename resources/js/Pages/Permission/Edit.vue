...
<template>
    <Head title="- گۆڕینی بازرگان"/>
    <div class="container mx-auto mt-4">
        <div class="flex items-center justify-between p-4 border border-gray-200 rounded-md">
            <h1 class="text-xl font-semibold  mb-6 text-gray-600">گۆڕینی ڕێگەپێدان / <span class="text-red-500">{{ props.permission.name }}</span></h1>
            <Link :href="route('permissions.index')" class="primary-btn">
                <span>گەڕانەوە</span>
