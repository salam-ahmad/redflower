...
const deletePayment = (payment) => {
    if (confirm('دڵنیای لە سڕینەوەی ئەم پارەدانە؟')) {
        router.delete(route('supplier-payments.destroy', payment.id))
    }
}
</script>
...
<template>
    <div class="p-4 container mx-auto space-y-4">
        ...
        <div class="flex items-center justify-between">
            <h1 class="text-2xl font-bold">پارەی دراو بە فرۆشیاران</h1>
            <Link :href="route('supplier-payments.create')" class="primary-btn">
                + زیادکردنی پارەدان
            </Link>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-4 gap-4">
                <div>
                    ...
                    <input
                        v-model="search"
                        type="text"
                        placeholder="گەڕان بە ناوی فرۆشیار، ژمارە..."
                        class="input-field"
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <div class="bg-white dark:bg-gray-800 border rounded p-4">
                <p class="text-sm text-gray-600 dark:text-gray-400">کۆی پارەی دراو</p>
            ...
            <div class="overflow-x-auto">
                <table class="w-full">
                    ...
                    <tr>
                        ...
                        <th class="px-4 py-3 text-right">فرۆشیار</th>
